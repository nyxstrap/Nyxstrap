/*
 *  Nyxstrap
 *  Copyright (c) Nyxstrap Team
 *
 *  This file is part of Nyxstrap and is distributed under the terms of the
...
namespace Bloxstrap.Integrations
{
    public class RobloxServerFetcher
    {
        ...
        public RobloxServerFetcher()
        {
            ...
            _client.DefaultRequestHeaders.UserAgent.ParseAdd("Roblox/Nyxstrap");
